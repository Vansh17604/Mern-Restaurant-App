  ...
  return (
    <div className="mt-8 bg-white rounded-lg border border-gray-200 shadow-sm p-6">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-800 mb-1">{t('viewdish.title')}</h1>
        </div>
        <p className="text-gray-500 text-sm">{t('viewdish.dis')}</p>
      </div>
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between">
          <Button
            ...
            className="flex items-center px-4 py-2 bg-purple-600 text-white border border-purple-600 hover:bg-purple-700 hover:border-purple-700 transition-all duration-200 rounded-md"
          >
        ...
        {isLoading ? (
          <div className="flex justify-center items-center py-16">
            <img
              ...
              className="h-16 w-16"
            />
            <span className="ml-3 text-gray-600">{t('viewdish.load')}</span>
          </div>
        ) : (
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{t('viewdish.label')}</th>
                  <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{t('viewdish.label1')}</th>
                  <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{t('viewdish.label2')}</th>
                  <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{t('viewdish.label3')}</th>
                  <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{t('viewdish.label4')}</th>
                  <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{t('viewdish.label5')}</th>
                  <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{t('viewdish.label6')}</th>
                </tr>
              </thead>
                  ...
                  <tr>
                    <td colSpan="7" className="px-6 py-10 text-center text-gray-500">
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-sm text-gray-400 mt-1">{t('viewdish.dis2')}</p>
                      </div>
                    </td>
                  </tr>
                )}
